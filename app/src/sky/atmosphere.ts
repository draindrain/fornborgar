...
export interface SkyState {
  /** Background and fog colour, authored as final display sRGB. */
  sky: THREE.Color;
...
const STOPS: readonly Stop[] = [
  { h: -90,     sky: rgb('#05070d'), sun: rgb('#000000'), sunIntensity: 0,     hemiSky: rgb('#20293d'), hemiGround: rgb('#0e1014'), hemiIntensity: 0.10, exposure: 3.2,   daylight: 0.05 },
  { h: -18,     sky: rgb('#070a12'), sun: rgb('#000000'), sunIntensity: 0,     hemiSky: rgb('#243050'), hemiGround: rgb('#101318'), hemiIntensity: 0.13, exposure: 3.0,   daylight: 0.06 },
  { h: -12,     sky: rgb('#10182c'), sun: rgb('#000000'), sunIntensity: 0,     hemiSky: rgb('#33456e'), hemiGround: rgb('#14161a'), hemiIntensity: 0.22, exposure: 2.4,   daylight: 0.10 },
  { h: -6,      sky: rgb('#2c3a56'), sun: rgb('#241a1c'), sunIntensity: 0,     hemiSky: rgb('#5b6f95'), hemiGround: rgb('#20211f'), hemiIntensity: 0.42, exposure: 1.7,   daylight: 0.26 },
  { h: -3,      sky: rgb('#57516a'), sun: rgb('#5a2f28'), sunIntensity: 0,     hemiSky: rgb('#8b849f'), hemiGround: rgb('#2e2c25'), hemiIntensity: 0.60, exposure: 1.35,  daylight: 0.42 },
  ...
  { h: -0.833,  sky: rgb('#8f6a63'), sun: rgb('#b04d24'), sunIntensity: 0,     hemiSky: rgb('#bd9186'), hemiGround: rgb('#3d382c'), hemiIntensity: 0.78, exposure: 1.15,  daylight: 0.58 },
  { h: -0.267,  sky: rgb('#9a7167'), sun: rgb('#bb5426'), sunIntensity: 0.16,  hemiSky: rgb('#c49489'), hemiGround: rgb('#3f392d'), hemiIntensity: 0.82, exposure: 1.13,  daylight: 0.60 },
  { h: 0,       sky: rgb('#a2766a'), sun: rgb('#c65a29'), sunIntensity: 0.45,  hemiSky: rgb('#c9968a'), hemiGround: rgb('#413b2e'), hemiIntensity: 0.85, exposure: 1.12,  daylight: 0.62 },
  { h: 2,       sky: rgb('#c19178'), sun: rgb('#f0813c'), sunIntensity: 1.10,  hemiSky: rgb('#d3a288'), hemiGround: rgb('#4a4232'), hemiIntensity: 0.92, exposure: 1.05,  daylight: 0.72 },
  { h: 6,       sky: rgb('#c9a68e'), sun: rgb('#ffab63'), sunIntensity: 1.90,  hemiSky: rgb('#c9a68e'), hemiGround: rgb('#504736'), hemiIntensity: 1.00, exposure: 1.0,   daylight: 0.84 },
  { h: 12,      sky: rgb('#b4b3ae'), sun: rgb('#ffd39a'), sunIntensity: 2.55,  hemiSky: rgb('#b4b3ae'), hemiGround: rgb('#544d3a'), hemiIntensity: 1.00, exposure: 1.0,   daylight: 0.93 },
  { h: 25,      sky: rgb('#9aabb8'), sun: rgb('#ffeccb'), sunIntensity: 2.95,  hemiSky: rgb('#9aabb8'), hemiGround: rgb('#554e3c'), hemiIntensity: 1.05, exposure: 1.0,   daylight: 0.99 },
  { h: 50,      sky: rgb('#8fa3b4'), sun: rgb('#fff4e6'), sunIntensity: 3.10,  hemiSky: rgb('#8fa3b4'), hemiGround: rgb('#554e3c'), hemiIntensity: 1.10, exposure: 1.0,   daylight: 1.0 },
  { h: 90,      sky: rgb('#86a0b6'), sun: rgb('#fff6ea'), sunIntensity: 3.15,  hemiSky: rgb('#86a0b6'), hemiGround: rgb('#554e3c'), hemiIntensity: 1.10, exposure: 1.0,   daylight: 1.0 },
];
